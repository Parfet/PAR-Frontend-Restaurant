...
const ChangeStatus = () => {
  ...
  return (
    <div className="bg-white rounded-25 p-16">
      ...
      <form onSubmit={formik.handleSubmit}>
        <div className="inline-block relative w-64 my-3">
          <select 
            ...
            className="block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline rounded-25"
            >
            {
        ...
        <div className="flex justify-center">
          <button className="bg-cusYellow hover:bg-cusYellow-500 text-white font-bold py-2 px-4 rounded-25" type="submit">
